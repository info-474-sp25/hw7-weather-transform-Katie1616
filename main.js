...
d3.csv("weather.csv").then(data => {
    ...
    */
    const pivotedData = groupedData2.flatMap(({ month, actualPrecip, avgPrecip, 
        recordPrecip }) => [
                {month, precip: actualPrecip, measurement: "Actual" },
                {month, precip: avgPrecip, measurement: "Average" },
                {month, precip: recordPrecip, measurement: "Record" }
            ]);// Your code here!
